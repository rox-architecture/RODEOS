# Contextualized Document: SCHUNK_JGZ_MISTRAL
...
<chunk_context>The Zwischenbacken ZBA-L-plus 80 are optional intermediate jaws that allow a 90° rotation of the mounting pattern for easier construction and manufacturing of adapter jaws, particularly for long versions, eliminating the need for deep through-holes. Made of aluminum, these jaws interface with the PGN-plus 80 finger system and are supplied individually. This component is part of the JGZ universal gripper series, which includes various sizes and configurations for industrial automation applications.</chunk_context>
<chunk>### Page 41
...
<chunk_context>The universal intermediate jaw UZB 80 is part of SCHUNK's JGZ series of universal grippers, designed for flexible mounting and quick jaw changes. It includes options for left/right connections and compatibility with finger blanks (ABR-/SBR-PGZN-plus 80) for custom machining. The section also details the compensation unit AGE-F and tolerance compensation unit TCU, which enhance precision and adaptability in automated handling applications. These components support the gripper's use in machine building, assembly, and automotive industries, with a maximum operating pressure warning above 6 bar. Key identifiers include UZB 80 (0300043) and TCU variants with ±4mm adjustment range.</chunk_context>
...
| TCU-2-080-3-OV | 0324785 | nein | $\pm 1 \% \pm 1 \% \pm 1^{\circ}$ |  |</chunk>

---

<chunk_context>The section details modular assembly automation components compatible with SCHUNK's JGZ universal grippers, including linear modules (CLM/KLM/LM/ELP/ELM/ELS/MLM) and adapter plates (ASG). It also covers inductive proximity switches (IN/INK series) and flexible position sensors (FPS-S with FPS-FS electronics) for end-position detection, with technical specifications and accessory options. These components integrate with the gripper system for enhanced automation functionality.</chunk_context>
...
(1) Beim Einsatz eines FPS-Systems wird pro Greifer ein FPS-Sensor (FPS-S) sowie eine Auswerteelektronik (FPS-FS) benötigt sowie, falls aufgeführt, ein Anbausatz (AS). Kabelverlängerungen (KV) sind optional im Katalogteil „Zubehör" erhältlich.</chunk>

---

<chunk_context>The section details electronic magnetic switches (MMS) for end-position detection in the JGZ universal gripper system, including standard and programmable variants. These sensors mount in the gripper's C-groove, with options for side cable exits and stainless steel housings, and require two sensors per unit for dual-position queries. The broader document outlines the SCHUNK JGZ series' technical specifications, accessories, and integration with modular automation systems, emphasizing precision and flexibility in industrial handling applications. Key components include MMS 22-S-M8-PNP (ID 0301032) and MMS 22-PI1-S-M8-PNP (ID 0301160), with compatible cables and distributors listed.</chunk_context>
<chunk>### Page 44
## Elektronischer Magnetschalter MMS
...
<chunk_context>The content details programmable magnetic switches (MMS 22-PI2, MMS-P, and MMS-IO-Link) and other sensor options for the SCHUNK JGZ universal gripper series. These components enable precise position monitoring, with features like dual programmable positions, IO-Link compatibility, and analog multi-position sensing. The section includes technical specifications, part numbers, and integration notes, aligning with the document’s focus on gripper accessories and automation solutions. Key identifiers include MMS 22-PI2-S-M8-PNP (0301180) and APS-Z80-M8 (0302070).</chunk_context>
<chunk>### Page 45
Programmierbarer Magnetschalter MMS 22-PI2
...
<chunk_context>The JGZ 100-1 series is part of SCHUNK's universal gripper product line, featuring a 10 mm stroke per jaw and grip forces up to 2700 N. This section provides technical specifications for three variants (JGZ 100-1, JGZ 100-1-AS, JGZ 100-1-IS), including operating pressures (2-8 bar), recommended workpiece weight (9 kg), and environmental tolerances (5-90°C). The data follows similar format to other JGZ models in the document, with force diagrams and dimensional details consistent with the product line's standardized presentation.</chunk_context>
<chunk>### Page 47
JGZ 80
Universalgreifer
...
| Bezeichnung |  | JGZ 100-1 | JGZ 100-1-A5 | JGZ 100-1-I5 |
| :--: | :--: | :--: | :--: | :--: |
| Ident.-Nr. |  | 0308940 | 0308941 | 0308942 |
| Hub pro Backe | [mm] | 10 | 10 | 10 |
| SchlieB-/Öffnungskraft | [K] | 1800/1920 | 2520/- | $\sim / 2700$ |
| Min. Federkraft | [K] |  | 720 | 780 |
| Eigenmasse | [kg] | 1.41 | 1.95 | 1.95 |
| Empfohlenes Werkstückgewicht | [kg] | 9 | 9 | 9 |
| Zylindervolumen pro Doppelhub | [cm3] | 120 | 120 | 120 |
| Min./Kenn-/max. Betriebsdruck | [bar] | 2/6/8 | 4/6/6.5 | 4/6/6.5 |
| Min./max. Sperrluftdruck | [bar] | $0.5 / 1$ | $0.5 / 1$ | $0.5 / 1$ |
| SchlieB-/Öffnungszeit | [s] | $0.1 / 0.1$ | $0.1 / 0.2$ | $0.2 / 0.1$ |
| SchlieB-/Öffnungszeit mit Feder | [s] |  | 0.25 | 0.25 |
| Max. zulässige Fingerlänge | [mm] | 125 | 115 | 115 |
| Max. zulässige Masse pro Finger | [kg] | 1.1 | 1.1 | 1.1 |
| Schutzart IP |  | 40 | 40 | 40 |
| Min./max. Umgebungstemperatur | [ ${ }^{\circ} \mathrm{C}$ ] | $5 / 90$ | $5 / 90$ | $5 / 90$ |
| Wiederholgenauigkeit | [mm] | 0.01 | 0.01 | 0.01 |
| Abmaße Ø $0 \times 2$ | [mm] | $115 \times 59.3$ | $115 \times 79.3$ | $115 \times 79.3$ |

(1) Die volle Greifkraft laut Datentabelle stellt sich unter Umständen erst nach einigen 100 Greifzyklen ein.</chunk>

---

<chunk_context>The JGZ 100-1 universal gripper's main view shows its basic configuration with closed jaws, highlighting key components like the direct air connections (A/B for opening/closing), locking air connection (5), and sensor interfaces (MMS 22/IN). Pages 50-51 detail accessory options including a tubeless M5 direct connection for pneumatic supply, spring-loaded pressure star (5mm stroke, 35N min force), AS/IS grip force retention system, and SDV-P pressure maintenance valve (8mm hose diameter). The PPD 20-IOL pneumatic positioning unit enables flexible force and speed adjustment, requiring an IO-Link or analog sensor. These components enhance the gripper's functionality in automation applications.</chunk_context>
<chunk>### Page 49
Hauptansicht
...
(1) Zusätzlich zur PPD ist ein Positionssensor (SCHUNK IO-Link Sensor oder Analogsensor ( $4 \ldots . .20 \mathrm{~mA}$ )) erforderlich.</chunk>

---

<chunk_context>The Backenschnellwechselsysteme BSWS section details interchangeable jaw systems for the JGZ 100-1 universal gripper, including adapter bolts, base systems, and finger blanks. These components enable quick jaw changes and are compatible with specific operating pressures up to 6 bar. The document provides part numbers and delivery contents for each variant (BSWS-A, BSWS-M, BSWS-R), emphasizing their use in automation and handling applications. This aligns with the broader product datasheet's focus on modularity and flexibility for industrial gripper systems.</chunk_context>
...
<chunk_context>The content details optional components for the JGZ 100-1 series universal gripper, specifically the ZBA-L-plus 100 intermediate jaws and UZB 100 universal intermediate jaws, which simplify construction by enabling a 90° rotation of mounting surfaces. It also covers finger blanks (ABR-/SBR-PGZN-plus 100) for custom machining and the AGE-F compensation unit for flexible mounting. Technical specifications include materials (aluminum, steel), part numbers (e.g., 0311742), and operational limits (e.g., max 6 bar pressure). The section aligns with the document’s focus on modular accessories for SCHUNK’s JGZ gripper series, emphasizing adaptability and precision in automation applications.</chunk_context>
<chunk>### Page 53
...
5518272
2.5
( Bei höherem Betriebsdruck als 6 bar muss die Eignung über die Einsatzgrenzen geprüft werden.
...
<chunk_context>The section describes modular automation components compatible with the JGZ universal gripper series, including linear modules (CLM/KLM/LM/ELP/ELM/ELS/HLM) and adapter plates (ASG). It also details inductive proximity switches (IN/INK series) and flexible position sensors (FPS-S with FPS-FS electronics) for precise end-position monitoring, with part numbers and accessory options. These components integrate with the gripper system for enhanced automation flexibility, referenced in the broader "Modulare Montageautomation" catalog. Key identifiers include IN 80-S-M8 (0301478) and FPS-S M8 (0301704).</chunk_context>
<chunk>## Modulare Montageautomation
...
| :-- | :-- |
| Anbausatz für FPS |  |
| AS-FPS-PGZN-plus 100-L | 0301634 |
| Sensor |  |
| FPS-S M8 | 0301704 |
| Auswerteelektronik |  |
| FPS-FS | 0301805 |
...
<chunk_context>The section details electronic magnetic switches (MMS) for end-position detection in the JGZ universal gripper series, including standard and programmable variants. These sensors mount in C-slots and integrate with gripper systems, offering options like side cable exits and stainless steel housings. The broader document outlines technical specifications, accessories, and compatibility across multiple gripper models (e.g., JGZ 40 to JGZ 160), emphasizing modular automation and sensor versatility. Key components include MMS 22-S-M8-PNP (ID 0301032) and MMS 22-PI1-S-M8-PNP (ID 0301160), with programming via teach tools (MT/ST).</chunk_context>
<chunk>### Page 56
## Elektronischer Magnetschalter MMS
...
| KV BW08-SGO8 3P-0030-PNP | 0301495 |  |
| KV BW08-SGO8 3P-0100-PNP | 0301496 |  |
| KV BW08-SGO8 3P-0200-PNP | 0301497 | - |
| Sensor-Verteiler |  |  |
| V2-M8 | 0301775 | - |
| V4-M8 | 0301746 |  |
| V8-M8 | 0301751 |  |
...
<chunk_context>The document details SCHUNK's JGZ series of universal grippers, focusing on sensor options for position monitoring. This section covers programmable magnetic switches (MMS 22-PI2 and MMS-P) with two configurable positions, IO-Link-enabled sensors for multi-position tracking, and reed switches/analog sensors for end-position detection. These components integrate with the gripper's C-slot mounting system, supporting flexible automation setups. Key variants include MMS 22-IOL-M08 (0315830) and APS-Z80-M8 (0302070), with programming via included tools or IO-Link interfaces. The sensors maintain the gripper's precision (0.01mm repeatability) and compatibility across JGZ models from 40-160mm sizes.</chunk_context>
<chunk>### Page 57
## Programmierbarer Magnetschalter MMS 22-PI2
...
<chunk_context>The JGZ 100 Universalgreifer is part of SCHUNK's product line, featuring technical specifications for the JGZ 125-1 series, including gripping forces, dimensions, and operational parameters. This section provides detailed data on variants (JGZ 125-1, JGZ 125-1-AS, JGZ 125-1-IS), such as closing/opening forces (3100/3330 K), recommended workpiece weight (15.5 kg), and maximum finger length (160 mm). The document emphasizes the greifer's robust design, with static load capacities and pneumatic operation, aligning with the broader theme of precision and reliability in industrial automation. Key figures include a 24-month warranty and compliance with ISO 8573-1:2010 for filtered compressed air.</chunk_context>
<chunk>### Page 59
JGZ 100
Universalgreifer
...
| Bezeichnung |  | JGZ 125-1 | JGZ 125-1-AS | JGZ 125-1-IS |
| :--: | :--: | :--: | :--: | :--: |
| Ident.-Nr. |  | 0308950 | 0308951 | 0308952 |
| Hub pro Backe | [mm] | 13 | 13 | 13 |
| SchlieB-/Öffnungskraft | [K] | 3100/3330 | 4150/- | $-/ 4400$ |
| Min. Federkraft | [K] |  | 1050 | 1070 |
| Eigenmasse | [kg] | 2.8 | 3.6 | 3.6 |
| Empfohlenes Werkstückgewicht | [kg] | 15.5 | 15.5 | 15.5 |
| Zylindervolumen pro Doppelhub | [cm3] | 230 | 230 | 230 |
| Min./Kenn-/max. Betriebsdruck | [bar] | 2/6/8 | 4/6/6.5 | 4/6/6.5 |
| Min./max. Sperrluftdruck | [bar] | $0.5 / 1$ | $0.5 / 1$ | $0.5 / 1$ |
| SchlieB-/Öffnungszeit | [s] | $0.2 / 0.2$ | $0.17 / 0.35$ | $0.35 / 0.17$ |
| SchlieB-/Öffnungszeit mit Feder | [s] |  | 0.40 | 0.40 |
| Max. zulässige Fingerlänge | [mm] | 160 | 145 | 145 |
| Max. zulässige Masse pro Finger | [kg] | 2.1 | 2.1 | 2.1 |
| Schutzart IP |  | 40 | 40 | 40 |
| Min./max. Umgebungstemperatur | [ ${ }^{\circ} \mathrm{C}$ ] | $5 / 90$ | $5 / 90$ | $5 / 90$ |
| Wiederholgenauigkeit | [mm] | 0.01 | 0.01 | 0.01 |
| Abmaße Ø $0 \times 2$ | [mm] | $140 \times 67$ | $140 \times 91.5$ | $140 \times 91.5$ |

(1) Die volle Greifkraft laut Datentabelle stellt sich unter Umständen erst nach einigen 100 Greifzyklen ein.</chunk>

---

<chunk_context>The JGZ 125-1 universal gripper's main view shows its basic configuration with closed jaws, highlighting key components like the direct connections (A/B for opening/closing), locking air connection (5), and sensor interfaces (MMS 22/IN). The subsequent section details optional accessories: a tubeless direct M5 connection for pneumatic supply, a spring-loaded pressure star (A-PZN-plus 125, 6mm hub, 105N min force), and AS/IS grip force retention variants. The SDV-P pressure maintenance valve ensures temporary pressure retention during emergencies, with recommended 8mm hose diameters. These components align with the document's focus on modular, high-performance gripping solutions for industrial automation.</chunk_context>
<chunk>### Page 61
 Hauptansicht 
...
<chunk_context>The pneumatische Positioniereinheit PPD enhances flexibility in pneumatic gripper applications by enabling adjustable positioning, gripping force, and speed. It requires an additional IO-Link or analog sensor (4-20 mA) for operation. The Backenschnellwechselsysteme BSWS section details quick-change jaw systems for grippers, specifying adapter bolts, base units, finger blanks, and locking mechanisms, with usage limited to listed systems at pressures ≤6 bar. Both components are part of the JGZ 125-1 universal gripper's accessory options, supporting modular automation solutions.</chunk_context>
<chunk>### Page 63
Pneumatische Positioniereinheit PPD
...
<chunk_context>The JGZ 125-1 universal gripper features modular quick-change systems (BSWS-M and BSWS-R) for adaptable finger mounting, with specific components listed including adapter bolts, base units, and finger blanks. These systems require evaluation for pressures above 6 bar and are limited to the configurations in the provided tables. The document details technical specifications and compatibility for automation applications, emphasizing precision and flexibility in industrial handling. Key components include BSWS-BM 125 (1302006) and BSWS-BR 125 (1555937) base units, with noted restrictions on operational parameters.</chunk_context>
<chunk>### Page 64
## Backenschnellwechselsystem BSWS-M
...
<chunk_context>The section details optional components for the JGZ 125-1 universal gripper, including the ZBA-L-plus 125 intermediate jaws and UZB 125 universal intermediate jaw, which simplify construction by allowing a 90° rotation of mounting patterns. It also covers finger blanks (ABR-/SBR-PGZN-plus 125) for custom machining and the AGE-F compensation unit for direct mounting. Technical specifications note a maximum operating pressure of 6 bar, beyond which suitability must be verified. These components enhance flexibility and ease of integration in handling applications.</chunk_context>
<chunk>### Page 65
...
| :--: | :--: | :--: | :--: | :--: |
| Ausgleichseinheit |  |  |  |  |
| TCU-2-125-3-MV | 0324820 | ja | $\pm 1 \% \pm 1 \% \pm 1^{\circ}$ | $\bullet$ |
| TCU-2-125-3-OV | 0324821 | nein | $\pm 1 \% \pm 1 \% \pm 1^{\circ}$ |  |</chunk>

---

<chunk_context>The section details sensor options for the JGZ universal gripper series, focusing on inductive proximity switches (IN series) and flexible position sensors (FPS) for end-position detection. These components are part of SCHUNK's modular automation system, compatible with grippers like the JGZ 160-1, and include accessories like cables and distributors. The sensors support precise positioning and monitoring, with variants for different mounting configurations (e.g., M8/M12 connectors). Technical specifications and part numbers are provided for integration. This aligns with the document's broader theme of gripper customization and automation solutions.</chunk_context>
<chunk>### Page 67
 Induktive Näherungsschalter 
...
| :-- | :-- | :-- |
| Anbausatz für FPS |  |  |
| AS-FPS-PGZN-plus 125-1/PZB 160 | 0301636 |  |
| Sensor |  |  |
| FPS-S MB | 0301704 |  |
| Auswerteelektronik |  |  |
| FPS-FS | 0301805 |  |
| Kabelverlängerung |  |  |
| KY BG08-SG08 3P-0050 | 0301598 |  |
| KY BG08-SG08 3P-0100 | 0301599 |  |
...
<chunk_context>The content details programmable magnetic switches (MMS 22-PI1, MMS 22-PI2, MMS-P, and MMS-IO-Link) and analog position sensors (APS-Z80) for the SCHUNK JGZ universal gripper series. These sensors enable precise position feedback, with options for single or multiple programmable positions, IO-Link connectivity, and analog measurement. The section includes technical specifications, part numbers, and compatibility notes, emphasizing integration with the gripper's C-mount system. This aligns with the document's focus on gripper accessories and automation solutions, particularly for industrial handling applications.</chunk_context>
<chunk>### Page 69
## Programmierbarer Magnetschalter MMS 22-PI1
...
<chunk_context>The zylindrische Reedschalter are part of the JGZ 160-1 series of universal grippers, designed for end-position detection via mounting adapters. This section details the required components (Anbausatz AS-RMS 80 and Reed-Schalter RMS 80-S-M8) and installation notes, including cable bend radius limits (35 mm). It precedes technical specifications for the JGZ 160-1 gripper, which includes a 16 mm stroke, 6000/6390 N closing/opening force, and 30 kg recommended workpiece weight. The gripper operates at 2–8 bar pressure with IP40 protection.</chunk_context>
<chunk>## Zylindrische Reedschalter
...
| Bezeichnung |  | JGZ 160-1 | JGZ 160-1-AS | JGZ 160-1-IS |
| :--: | :--: | :--: | :--: | :--: |
| Ident.-Nr. |  | 0308960 | 0308961 | 0308962 |
| Hub pro Backe | [mm] | 16 | 16 | 16 |
| SchlieB-/Öffnungskraft | [K] | 6000/6390 | 7990/- | $\sim / 8480$ |
| Min. Federkraft | [K] |  | 1990 | 2090 |
| Eigenmasse | [kg] | 5.6 | 8 | 8 |
| Empfohlenes Werkstückgewicht | [kg] | 30 | 30 | 30 |
| Zylindervolumen pro Doppelhub | [cm3] | 520 | 520 | 520 |
| Min./Kenn-/max. Betriebsdruck | [bar] | 2/6/8 | 4/6/6.5 | 4/6/6.5 |
| Min./max. Sperrluftdruck | [bar] | $0.5 / 1$ | $0.5 / 1$ | $0.5 / 1$ |
| SchlieB-/Öffnungszeit | [s] | $0.5 / 0.5$ | $0.4 / 0.8$ | $0.8 / 0.4$ |
| SchlieB-/Öffnungszeit mit Feder | [s] |  | 0.80 | 0.80 |
| Max. zulässige Fingerlänge | [mm] | 200 | 180 | 180 |
| Max. zulässige Masse pro Finger | [kg] | 3.5 | 3.5 | 3.5 |
| Schutzart IP |  | 40 | 40 | 40 |
| Min./max. Umgebungstemperatur | [ ${ }^{\circ} \mathrm{C}$ ] | $5 / 90$ | $5 / 90$ | $5 / 90$ |
| Wiederholgenauigkeit | [mm] | 0.02 | 0.02 | 0.02 |
| Abmaße $\varnothing 0 \times 2$ | [mm] | $180 \times 81$ | $180 \times 111$ | $180 \times 111$ |

(1) Die volle Greifkraft laut Datentabelle stellt sich unter Umständen erst nach einigen 100 Greifzyklen ein.</chunk>

---

<chunk_context>The JGZ 160-1 universal gripper's main view shows its basic configuration with closed jaws, highlighting key components like the pneumatic connections (A/B for opening/closing), locking air connection (5), and sensor interfaces (MMS 22/IN). The subsequent pages detail accessory options: a direct M4 hose-free connection for cleaner pressure supply, a spring-loaded pressure star (A-PZN-plus 160, 6mm hub, 150N min force), and the AS/IS grip force retention system that ensures minimum force during pressure drops. The SDV-P pressure maintenance valve (SDV-P 07, 8mm hose) maintains pressure in emergency scenarios, while the PPD 40-IOL pneumatic positioning unit (1540701) enables flexible force and speed adjustments, requiring an additional IO-Link or analog sensor. These components enhance functionality for machine loading and automation applications.</chunk_context>
<chunk>### Page 73
Hauptansicht
...
(1) Zusätzlich zur PPD ist ein Positionssensor (SCHUNK 10-Link Sensor oder Analogsensor (4... 20 mA)) erforderlich.</chunk>

---

<chunk_context>The Backenschnellwechselsysteme BSWS section details interchangeable jaw systems for the JGZ 160-1 pneumatic gripper, part of SCHUNK's Universalgreifer JGZ series. It lists three variants (BSWS-M, BSWS-R, and standard BSWS) with adapter bolts, base units, finger blanks, and locking mechanisms, each with specific part numbers and delivery contents. These systems enable quick jaw changes for the gripper, with operational limits requiring evaluation for pressures above 6 bar. The content aligns with the document's focus on modular automation components for industrial handling applications.</chunk_context>
<chunk>## Backenschnellwechselsysteme BSWS
...
<chunk_context>The Zwischenbacken ZBA-L-plus 160 and universelle Zwischenbacke UZB 160 are optional components for the JGZ 160-1 pneumatic gripper, enabling 90° rotation of mounting surfaces for simplified construction. These aluminum or steel accessories (e.g., ZBA-L-plus 160, Ident.-Nr. 0311762) facilitate easier machining by eliminating deep through-holes. The section also details finger blanks (ABR-/SBR-PGZN-plus 160) for custom machining and the TCU tolerance compensation unit with ±1° deflection capability. These components integrate with the JGZ series' modular system, complementing its technical specifications like the 160mm maximum finger length and 6 bar operating pressure limit.</chunk_context>
<chunk>### Page 77
...
| :--: | :--: | :--: | :--: | :--: |
| Ausgleichseinheit |  |  |  |  |
| TCU-2-160-3-MV | 0324838 | ja | $\pm 1^{\circ} / \pm 1^{\circ} / \pm 1^{\circ}$ | $\bullet$ |
| TCU-2-160-3-OV | 0324839 | nein | $\pm 1^{\circ} / \pm 1^{\circ} / \pm 1^{\circ}$ |  |</chunk>

---

<chunk_context>The section details sensor options for the JGZ 160-1 series universal gripper, including inductive proximity switches (IN 80-S-M8/M12), flexible position sensors (FPS-S), and electronic magnetic switches (MMS 22-S-M8-PNP). These components enable precise end-position detection and multi-position monitoring, with variants offering different mounting options (direct or side cable exit) and compatibility with accessories like cable extensions and distributors. The MMS 22-PI1 programmable magnetic switch allows customizable position sensing via teach tools. These sensors integrate with the gripper’s C-groove mounting system, supporting automation in handling applications. Key part numbers include 0301578 (IN 80-S-M12) and 0301160 (MMS 22-PI1-S-M8-PNP).</chunk_context>
<chunk>### Page 79
## Induktive Näherungsschalter
...
| :-- | :-- |
| Anbausatz für FPS |  |
| AS-FPS-PGZN-plus 160-L | 0301638 |
| Sensor |  |
| FPS-S M8 | 0301704 |
| Auswerteelektronik |  |
| FPS-F5 | 0301805 |
...
<chunk_context>The content details programmable magnetic switches (MMS 22-PI2, MMS-P, and MMS-IO-Link) and other sensor options for the JGZ 160 universal gripper, including reed switches and analog position sensors. These components enable precise position monitoring and flexible programming via IO-Link or teach tools, with variants for different mounting and connectivity needs. The section is part of the broader technical specifications and accessory options for SCHUNK's JGZ gripper series, emphasizing modularity and integration with automation systems. Key identifiers include MMS 22-PI2-S-M8-PNP (0301180) and APS-Z80-M8 (0302070).</chunk_context>
<chunk>### Page 81
Programmierbarer Magnetschalter MMS 22-PI2
...
| Bezeichnung | Ident.-Nr. | $\begin{aligned} & \text { oft } \\ & \text { kombiniert } \end{aligned}$ |
| :--: | :--: | :--: |
| Anbausatz für APS-Z80 |  |  |
...
<chunk_context>The JGZ 160 universal gripper concludes the product datasheet, followed by SCHUNK's company information and contact details. This section provides the manufacturer's address, phone, fax, email, and website, along with social media references. The document focuses on SCHUNK's expertise in clamping, gripping, and automation technology, headquartered in Lauffen/Neckar, Germany.</chunk_context>
<chunk>### Page 83
JGZ 160
Universalgreifer
